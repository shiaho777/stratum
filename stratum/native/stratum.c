 ...
 * The include list is auto-generated by the Makefile (stratum_archs.gen.h,
 * built from `stratum_arch_*.inc.c` in this directory). Adding a new
 * architecture = drop its .inc.c file here and rebuild; do not edit this
 * include by hand. */
#include "stratum_archs.gen.h"
